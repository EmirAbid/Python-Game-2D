...
class Projectile(pygame.sprite.Sprite):
    ...
    def __init__(self,player):
        ...
        self.velocity = 5
        self.player = player
        self.image = pygame.image.load('C:/Users/Emir Abid/Desktop/Emir/Coding/EXercice python/Project-Python/Python-Game/assets/assets/projectile.png')
