...
#creer une seconde classe qui va representre notre jeu 
class Game: 
    def __init__(self):
        #definir si notre jeua commencé ou non 
    ...
    def update(self, screen):
        ...
        #appliquer l'ensemble des images de mo groupe 
